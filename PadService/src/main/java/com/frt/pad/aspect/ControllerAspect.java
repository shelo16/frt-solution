...
import com.frt.pad.service.util.JwtUtil;
...
public class ControllerAspect {
    ...
    @Pointcut("within(com.frt.pad.controller.OrderDeliveryController)")
    public void orderDeliveryControllerMethods() {
    }

    @Pointcut("within(com.frt.pad.controller..*)")
    public void allControllerMethods() {
    }

    @Pointcut("orderDeliveryControllerMethods()")
    public void beforeOrderDeliveryControllerMethods() {
    }
    ...
    @Before("beforeOrderDeliveryControllerMethods()")
    @Order(2)
    public void validateUserBeforeInvokingOperations(JoinPoint joinPoint) throws AuthenticationException {
